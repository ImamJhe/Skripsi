...
/*void wifi(void) {
  ...
  wifiManager.autoConnect("ADS1293_1","");
...
minLife_11 = 10000000;  
  ...
  //Serial.println(maxLife_11);
  int x11 = maxLife_11;
  int x12 = maxLife_11 - 4000;
  for(int i = 0; i <= 88; i++){//shift graph
...
setInterval(function ( ) {
  ...
  xhttp.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200) {
      ...
      if(chartT.series[0].data.length > 480) {
  ...
  xhttp.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200) {
      var x = (new Date()).getTime(),
          y = parseFloat(this.responseText);
      //console.log(this.responseText);
      if(chartT.series[1].data.length > 480) {
  ...
  xhttp.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200) {
      var x = (new Date()).getTime(),
          y = parseFloat(this.responseText);
      //console.log(this.responseText);
      if(chartT.series[2].data.length > 480) {
